...
def generate_post(post_type, theme, used_texts, topic, sodan_used=False, day_topics=None):
...
def main():
    ...
    for day_offset in range(7):
        ...
        for i, time_str in enumerate(SCHEDULE):
            ...
            text = generate_post(post_type, theme, all_used_texts, topic, sodan_used, day_topics=day_topics)
            # 「ご相談ください」使用を追跡
